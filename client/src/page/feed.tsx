...
import { ArticleComments } from "../components/comment/article_comments";
          ...
          <>
            ...
            <main className="wauto">
              ...
              <div className="m-2 flex flex-col items-center justify-center">
                <ArticleComments feedId={feed.id} />
              </div>
              <div className="h-16" />
            </main>
...
export function TOCHeader(props: { TOC: () => JSX.Element }) {
  return <FeedTocHeader {...props} />;
}
