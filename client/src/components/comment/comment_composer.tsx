...
import { uploadImageFile, buildMarkdownImage, getImageUploadErrorMessage } from "../../utils/image-upload";
...
export function CommentComposer({
    ...
    async function handleImageUpload(file: File) {
        ...
        try {
            ...
            showAlert(getImageUploadErrorMessage(e, t));
        } finally {
            setUploading(false);
    ...
    return (
        ...
        >
            ...
            <div
                className={`mb-3 w-full overflow-hidden rounded-lg border bg-w ${
                    replyTo
            ...
            >
                <textarea
                    ...
                    className="min-h-24 w-full resize-y bg-transparent px-3 py-2 outline-none"
                    value={content}
